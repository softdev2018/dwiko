  ...
  <div class="wrap">
	<div class="header">
		<div class="headertop_desc">
			<div class="call">
				 <p><span>Need help?</span> call us <span class="number">xxx-xxx-xxx-xxx</span></span></p>
			</div>
     ...
     echo "<a href='logout.php'> <button type='button' class='btn btn-default btn-sm'>
		...
		<div class="header_top">
			<div class="logo">
			  ...
			  <div class="cart">
			  	   <p>Selamat Datang,<br/> <span>Cart:</span><div id="dd" class="wrapper-dropdown-2"> 0 item(s) - Rp.0
			  	   	<ul class="dropdown">
